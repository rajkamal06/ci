...
function myFunction(id)
      ...
      alert(id)
			...
			{
				$.ajax({
					url:'<?php echo base_url('admin/Active/delete'); ?>',
					method:"post",
					dataType:"json",
					data:{id:id},
...
?>
 ...
 <tr style="background:#CCC">
  ...
  <td><?=$vs->price?></td>
  <td><?=$vs->sell_price?></td>
  <td><a  class="btn btn-primary" href="<?=base_url('admin/active/status_inactive/'.$vs->id)?>">Inactive</a></td>

  <td><a  class="btn btn-primary" href="<?=base_url('admin/Category/edit/'.$vs->id)?>">Edit</a>|<a href="<?=base_url('admin/Category/view/'.$vs->id)?>" class="btn btn-info">View</a> | <button class="btn btn-info" onclick='myFunction("<?=$vs->id?>")'> delete</button></td>
  </tr>
   <?PHP
   endforeach;
   ?>
