...
<a  class="btn btn-primary" href="<?= base_url('admin/subcategory/index') ?>">Back</a>
</div>
<h1>Update Form</h1>
<?php echo validation_errors(); ?>
  <form action="<?= base_url('admin/subcategory/update/'.$data['id']) ?>"  id="registration" method="post">
...
<div class="row">
    ...
    <div class="col-75">
      <input type="text" id="category_id" name="category_id" value = "<?php echo $data['category_id'] ;?>"  placeholder=" Category_id.."><br>
