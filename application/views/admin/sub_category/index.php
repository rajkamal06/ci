...
<a  class="btn btn-primary" href=" <?= base_url('admin/subcategory/sub_category') ?>">Add new</a>
</div>
...
?>
 ...
 <tr style="background:#CCC">
  ...
  <tr>
  <td><?=$vs->id?></td>
  <td><?=$vs->category_id?></td>
  <td><?=$vs->name?></td>
  <td><?=$vs->description?></td>
  <td><?=$vs->file?></td>
  <td><?=$vs->status?></td>
  
  <td><a  class="btn btn-primary" href="<?=base_url('admin/subcategory/edit/'.$vs->id)?>">Edit</a>|<a href="<?=base_url('admin/subcategory/view/'.$vs->id)?>" class="btn btn-info">View</a>|<a href="<?=base_url('admin/subcategory/delete/'.$vs->id)?>" class="btn btn-success">Delete</a></td>
  </tr>
   <?PHP
   endforeach;
   ?>
