                                ...
                                <div class="header-element right-block-box">
                                    <ul class="shop-element">
                                        ...
                                        <li class="side-wrap cart-wrap">
                                         ...
                                         <li class="side-wrap user-wrap">
                                            <div class="user-icon">
                                                <a href="profile.html" class="user-icon-desk">
                                                    <span><i class="icon-user"></i></span>
                                                </a>
                                            </div>
                                        </li>
                                        ...
                                        <div class="megamenu-content">
                                            <div class="mainwrap">
                                                <ul class="main-menu">
                                                    ...
                                                    <li class="menu-link parent">
                                                        <a href="about_us.html" class="link-title">
                                                    ...
                                                    <li class="menu-link parent">
                                                        <a href="Privacy_policy.html" class="link-title">
                                                    ...
                                                    <li class="menu-link parent">
                                                        <a href="gallery.html" class="link-title">
                    ...
                    <div class="order-history">
                        <div class="profile">
                            ...
                            <div class="order-his-page">
                                <ul class="pro-input-label-1">
                                    <li>
                                       <a href="">Login Password <i class="icon-lock"></i></a>
                                ...
                                <ul class="pro-input-label">
                                    ...
                                    <li>
                                       <label>A/C Number </label>
                                        <input type="text" name="account_number" placeholder="Status" required>
                                    </li>
                                    <li>
                                       <label>IFSC Code </label>
                                        <input type="text" name="ifsc_code" placeholder="Status" required>
                                    </li>
                                </ul>
                                <br>
                                <h5>Address</h5>
                    ...
                    <div class="col">
                        <ul class="f-bottom">
                            ...
                            <li class="f-c f-payment">
                                <a href="javascript:void(0)"><img src="image/payment.png" class="img-fluid" alt="payment image"></a>
                            </li>
                        </ul>
                    </div>
                </div>
...
<!-- Mirrored from spacingtech.com/html/vegist-final/vegist/profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 19 Aug 2021 06:33:28 GMT -->
</html>